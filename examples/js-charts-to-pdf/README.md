> Full guide: [JS charts to PDF](https://ironpdf.com/examples/js-charts-to-pdf/?utm_source=github)
...
For more comprehensive details on the capabilities of the `ChromePdfRenderOptions` class, visit the [JavaScript Charts to PDF Code Example](https://ironpdf.com/java/examples/js-charts-to-pdf/?utm_source=github).
...
[Discover the method to Enable JavaScript for PDF Rendering](https://ironpdf.com/java/object-reference/api/com/ironsoftware/ironpdf/render/ChromePdfRenderOptions.html?utm_source=github#setEnableJavaScript(boolean))