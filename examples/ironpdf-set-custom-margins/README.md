> Full guide: [Ironpdf set custom margins](https://ironpdf.com/examples/ironpdf-set-custom-margins/?utm_source=github)
...
Further explore customization capabilities through the [ChromePdfRenderOptions API](https://ironpdf.com/java/object-reference/api/com/ironsoftware/ironpdf/render/ChromePdfRenderOptions.html?utm_source=github).