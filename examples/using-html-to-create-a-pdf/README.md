...
Adjustments to the resultant PDF's appearance can be made using the `ChromePdfRenderOptions` class. For further details on customization, see the [ChromePdfRenderOptions API Documentation](https://ironpdf.com/java/object-reference/api/com/ironsoftware/ironpdf/render/ChromePdfRenderOptions.html?utm_source=github).

For a more guide on converting HTML to PDF in Java, visit [Explore the Complete HTML to PDF Tutorial for Java](https://ironpdf.com/java/tutorials/html-to-pdf/?utm_source=github).